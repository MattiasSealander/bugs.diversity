...
# ---- Load packages ----
pacman::p_load(
  codyn, data.table, ggsci, ggplot2, IRanges, tidyverse, here
)
...
# ---- 10. Save figure ----
ggsave(
  "004-species-turnover-britain.jpg",
  fig,
  device = "jpg",
...
message("✅ Species turnover analysis complete and figure saved: '003-species-turnover-britain.jpg'")
