############################################################
# Script: 004-rank-abundance-change-optimized.R
# Purpose: Calculate temporal changes in rank-abundance curves (RAC)
#          across 500-year bins for European insect fossil data.
...
hits_df <- tibble(
  ...
  inner_join(bugs_filtered, by = c("sample", "sample_group", "site")) %>%
...
message("✅ RAC analysis complete and figure saved: '004-rank-abundance-change.jpg'")
