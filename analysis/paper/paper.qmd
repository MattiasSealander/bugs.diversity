...
# --------------------------------------------------------------
time_mat <- bugs %>%
  select(country, latitude, longitude, site, sample_id, sample, age_older, age_younger, context) %>%
