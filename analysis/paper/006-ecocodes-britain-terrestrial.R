...
eco_species <- eco %>%
  filter(ecocode_system == "Bugs",
         !ecocode %in%  c("Aquatics", "Indicators: Running water", "Indicators: Standing water",
  "Open wet habitats", "Wetlands/marshes")) %>%
...
# ==============================================================
ecocode_levels <- c(
  "Mould beetles", "Halotolerant", "Carrion", "General synanthropic", "Stored grain pest",
  ...
  "Indicators: Deciduous", "Indicators: Coniferous", "Dry dead wood", "Meadowland"
)

colors <- c(
  "#370335FF", "#1A9993FF", "#8A9197FF", "#FD8CC1FF", "#D2AF81FF", "#91331FFF", "#FED439FF", "darkred", "salmon1",
...
# 12. Save figure
# ==============================================================
ggsave(filename = "006-ecocodes-britain-terrestrial.jpg",
