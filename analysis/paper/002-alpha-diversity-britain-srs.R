...
#   It applies the SRS (Scaling with Ranked Subsampling) method to standardize
#   abundance matrices, then computes alpha diversity metrics (Shannon, and Inverse Simpson)
#   for each 500-year time slice.
#
# Workflow overview:
...
#   4. Standardize sample abundance data using SRS.
...
#   - Figure: "002-alpha-diversity-britain-srs.jpg"
